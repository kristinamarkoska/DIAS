...
public class FilterThree implements Filter<List<CompanyIssuerModel>> {
    ...
    public FilterThree(CompanyIssuerRepository companyIssuerRepository, CompanyDataRepository companyDataRepository) {
        this.companyIssuerRepository = companyIssuerRepository;
        this.companyDataRepository = companyDataRepository;
    }

    public List<CompanyIssuerModel> execute(List<CompanyIssuerModel> input) throws IOException, ParseException {
