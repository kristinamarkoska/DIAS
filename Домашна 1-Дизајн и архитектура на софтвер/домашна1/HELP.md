...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/3.3.5/reference/assetHistory/sql.html#assetHistory.sql.jdbc)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.3.5/reference/assetHistory/sql.html#assetHistory.sql.jpa-and-spring-assetHistory)
...
* [Using Spring Data JDBC](https://github.com/spring-projects/spring-assetHistory-examples/tree/master/jdbc/basics)
* [Accessing Data with JPA](https://spring.io/guides/gs/accessing-assetHistory-jpa/)
